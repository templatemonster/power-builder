...
function tm_builder_load_modules_styles() {
	...
	wp_localize_script( 'tm-builder-modules-script', 'tm_pb_custom', array(
		...
		'subscription_failed'    => esc_html__( 'Please, check the fields below to make sure you entered the correct information.', 'power-builder' ),
		'fill_message'           => esc_html__( 'Please, fill in the following fields:', 'power-builder' ),
		'contact_error_message'  => esc_html__( 'Please, fix the following errors:', 'power-builder' ),
		'invalid'                => esc_html__( 'Invalid email', 'power-builder' ),
		'captcha'                => esc_html__( 'Captcha', 'power-builder' ),
		'prev'                   => esc_html__( 'Prev', 'power-builder' ),
		'previous'               => esc_html__( 'Previous', 'power-builder' ),
		'next'                   => esc_html__( 'Next', 'power-builder' ),
		'wrong_captcha'          => esc_html__( 'You entered the wrong number in captcha.', 'power-builder' ),
