...
class Tm_Builder_Module_Slider_Item extends Tm_Builder_Module {
	function init() {
		$this->name                        = esc_html__( 'Slide', 'power-builder' );
		...
		$this->advanced_setting_title_text = esc_html__( 'New Slide', 'power-builder' );
		$this->settings_text               = esc_html__( 'Slide Settings', 'power-builder' );
		...
		$this->advanced_options = array(
			...
			'button' => array(
				'button' => array(
					'label' => esc_html__( 'Button #1', 'power-builder' ),
					'css'      => array(
						'main' => "{$this->main_css_element}.tm_pb_slide .tm_pb_button.tm_btn_1",
					),
				),
				'button_2' => array(
					'label' => esc_html__( 'Button #2', 'power-builder' ),
					'css'      => array(
	...
	function get_fields() {
		$fields = array(
			'heading' => array(
				'label'           => esc_html__( 'Heading', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define the title text for your slide.', 'power-builder' ),
			),
			'button_text' => array(
				'label'           => esc_html__( 'Button 1 Text', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define the text for the slide button #1', 'power-builder' ),
			),
			'button_link' => array(
				'label'           => esc_html__( 'Button 1 URL', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input a destination URL for the slide button #1.', 'power-builder' ),
			),
			'button_2_text' => array(
				'label'           => esc_html__( 'Button 2 Text', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define the text for the slide button #2', 'power-builder' ),
			),
			'button_2_link' => array(
				'label'           => esc_html__( 'Button 2 URL', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input a destination URL for the slide button #2.', 'power-builder' ),
			),
			'background_image' => array(
				...
				'description'        => esc_html__( 'If defined, this image will be used as the background for this module. To remove a background image, simply delete the URL from the settings field.', 'power-builder' ),
			),
			...
			'background_size' => array(
				...
				'options'         => array(
					'default' => esc_html__( 'Default', 'power-builder' ),
					'cover'   => esc_html__( 'Cover', 'power-builder' ),
			...
			'image' => array(
				...
				'upload_button_text' => esc_attr__( 'Upload an image', 'power-builder' ),
				'choose_text'        => esc_attr__( 'Choose a Slide Image', 'power-builder' ),
				'update_text'        => esc_attr__( 'Set As Slide Image', 'power-builder' ),
				'description'        => esc_html__( 'If defined, this slide image will appear to the left of your slide text. Upload an image, or leave blank for a text-only slide.', 'power-builder' ),
			),
			...
			'use_heading_bg_image'      => array(
				'label'           => esc_html__( 'Use heading background image', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
			...
			'heading_bg_image' => array(
				'label'              => esc_html__( 'Heading background Image', 'power-builder' ),
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				'upload_button_text' => esc_attr__( 'Upload an image', 'power-builder' ),
				'choose_text'        => esc_attr__( 'Choose a Heading Background Image', 'power-builder' ),
				'update_text'        => esc_attr__( 'Set As Heading Background', 'power-builder' ),
				'description'        => esc_html__( 'If defined, this image will be used as the background for this module. To remove a Heading background image, simply delete the URL from the settings field.', 'power-builder' ),
			),
			'alignment' => array(
				'label'           => esc_html__( 'Slide Image Vertical Alignment', 'power-builder' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
					'center' => esc_html__( 'Center', 'power-builder' ),
				...
				'description' => esc_html__( 'This setting determines the vertical alignment of your slide image. Your image can either be vertically centered, or aligned to the bottom of your slide.', 'power-builder' ),
			),
			'video_url' => array(
				'label'           => esc_html__( 'Slide Video', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'If defined, this video will appear to the left of your slide text. Enter youtube or vimeo page url, or leave blank for a text-only slide.', 'power-builder' ),
			),
			'image_alt' => array(
				'label'           => esc_html__( 'Image Alternative Text', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'If you have a slide image defined, input your HTML ALT text for the image here.', 'power-builder' ),
			),
			'video_bg_mp4' => array(
			...
			'video_bg_width' => array(
				...
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'In order for videos to be sized correctly, you must input the exact width (in pixels) of your video here.' ,'power-builder' ),
			),
			'video_bg_height' => array(
				'label'           => esc_html__( 'Background Video Height', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'In order for videos to be sized correctly, you must input the exact height (in pixels) of your video here.' ,'power-builder' ),
			),
			'allow_player_pause' => array(
				...
				'description'     => esc_html__( 'Allow video to be paused by other players when they begin playing' ,'power-builder' ),
			),
			'content_new' => array(
				'label'           => esc_html__( 'Content', 'power-builder' ),
				'type'            => 'tiny_mce',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Input your main slide text content here.', 'power-builder' ),
			),
			...
			'admin_title' => array(
				...
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the slide in the builder for easy identification.', 'power-builder' ),
			),
