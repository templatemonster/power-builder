...
class Tm_Builder_Module_Slider extends Tm_Builder_Module {
	function init() {
		$this->name             = esc_html__( 'Slider', 'power-builder' );
		$this->icon             = 'f03e';
		$this->slug             = 'tm_pb_slider';
		$this->child_slug       = 'tm_pb_slide';
		$this->child_item_text  = esc_html__( 'Slide', 'power-builder' );
	...
	function get_fields() {
		$fields = array(
			'show_arrows'         => array(
				'label'           => esc_html__( 'Arrows', 'power-builder' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'Show Arrows', 'power-builder' ),
					'off' => esc_html__( 'Hide Arrows', 'power-builder' ),
				),
			...
			'fullheight' => array(
				'label'           => esc_html__( 'Slider fullheight', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'options'         => array(
				...
				'description'     => esc_html__( 'This setting will turn on and off slider fullheight.', 'power-builder' ),
			),
			'auto' => array(
			...
			'show_image_video_mobile' => array(
				'label'           => esc_html__( 'Show Image / Video On Mobile', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
