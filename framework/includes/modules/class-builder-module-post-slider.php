...
class Tm_Builder_Module_Post_Slider extends Tm_Builder_Module {
	function init() {
		$this->name = esc_html__( 'Post Slider', 'power-builder' );
		...
		$this->custom_css_options = array(
			'slide_description' => array(
				'label'    => esc_html__( 'Slide Description', 'power-builder' ),
				'selector' => '.tm_pb_slide_description',
			),
			'slide_title' => array(
				'label'    => esc_html__( 'Slide Title', 'power-builder' ),
				'selector' => '.tm_pb_slide_description .tm_pb_slide_title',
			),
			'slide_button' => array(
				'label'    => esc_html__( 'Slide Button', 'power-builder' ),
				'selector' => 'a.tm_pb_more_button',
			),
			'slide_controllers' => array(
				'label'    => esc_html__( 'Slide Controllers', 'power-builder' ),
				'selector' => '.et-pb-controllers',
			),
			'slide_active_controller' => array(
				'label'    => esc_html__( 'Slide Active Controller', 'power-builder' ),
				'selector' => '.et-pb-controllers .et-pb-active-control',
			),
			'slide_image' => array(
				'label'    => esc_html__( 'Slide Image', 'power-builder' ),
				'selector' => '.tm_pb_slide_image',
			),
			'slide_arrows' => array(
				'label'    => esc_html__( 'Slide Arrows', 'power-builder' ),
	...
	function get_fields() {
		$fields = array(
			'posts_number' => array(
				...
				'description'       => esc_html__( 'Choose how many posts you would like to display in the slider.', 'power-builder' ),
			),
			'include_categories' => array(
				...
				'description'      => esc_html__( 'Choose which categories you would like to include in the slider.', 'power-builder' ),
			),
			'orderby' => array(
				'label'             => esc_html__( 'Order By', 'power-builder' ),
				'type'              => 'select',
				'option_category'   => 'configuration',
				'options'           => array(
					'date_desc'  => esc_html__( 'Date: new to old', 'power-builder' ),
					'date_asc'   => esc_html__( 'Date: old to new', 'power-builder' ),
					'title_asc'  => esc_html__( 'Title: a-z', 'power-builder' ),
					'title_desc' => esc_html__( 'Title: z-a', 'power-builder' ),
					'rand'       => esc_html__( 'Random', 'power-builder' ),
				),
				'description'       => esc_html__( 'Here you can adjust the order in which posts are displayed.', 'power-builder' ),
			),
			'show_arrows'         => array(
				'label'           => esc_html__( 'Show Arrows', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
				...
				'description'     => esc_html__( 'This setting will turn on and off the navigation arrows.', 'power-builder' ),
			),
			'show_pagination' => array(
				'label'             => esc_html__( 'Show Controls', 'power-builder' ),
				'type'              => 'yes_no_button',
				'option_category'   => 'configuration',
				'options'           => array(
					'on'  => esc_html__( 'Yes', 'power-builder' ),
				...
				'description'       => esc_html__( 'This setting will turn on and off the circle buttons at the bottom of the slider.', 'power-builder' ),
			),
			'show_more_button' => array(
				'label'             => esc_html__( 'Show Read More Button', 'power-builder' ),
				'type'              => 'yes_no_button',
				'option_category'   => 'configuration',
				'options'           => array(
					'on'  => esc_html__( 'yes', 'power-builder' ),
				...
				'description'       => esc_html__( 'This setting will turn on and off the read more button.', 'power-builder' ),
			),
			'more_text' => array(
				...
				'option_category'   => 'configuration',
				'depends_show_if'   => 'on',
				'description'       => esc_html__( 'Define the text which will be displayed on "Read More" button. leave blank for default ( Read More )', 'power-builder' ),
			),
			'content_source' => array(
				'label'             => esc_html__( 'Content Display', 'power-builder' ),
				'type'              => 'select',
				'option_category'   => 'configuration',
				'options'           => array(
					'off' => esc_html__( 'Show Excerpt', 'power-builder' ),
					'on'  => esc_html__( 'Show Content', 'power-builder' ),
				),
				'affects' => array(
					'#tm_pb_use_manual_excerpt',
					'#tm_pb_excerpt_length',
				),
				'description'       => esc_html__( 'Showing the full content will not truncate your posts in the slider. Showing the excerpt will only display excerpt text.', 'power-builder' ),
			),
			'use_manual_excerpt' => array(
				'label'             => esc_html__( 'Use Post Excerpt if Defined', 'power-builder' ),
				'type'              => 'yes_no_button',
				'option_category'   => 'configuration',
				'options'           => array(
					'on'  => esc_html__( 'Yes', 'power-builder' ),
				...
				'depends_show_if'   => 'off',
				'description'       => esc_html__( 'Disable this option if you want to ignore manually defined excerpts and always generate it automatically.', 'power-builder' ),
			),
			'excerpt_length' => array(
				'label'             => esc_html__( 'Automatic Excerpt Length', 'power-builder' ),
				'type'              => 'text',
				'option_category'   => 'configuration',
				'depends_show_if'   => 'off',
				'description'       => esc_html__( 'Define the length of automatically generated excerpts. Leave blank for default ( 55 ) ', 'power-builder' ),
			),
			'show_meta' => array(
				'label'           => esc_html__( 'Show Post Meta', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'yes', 'power-builder' ),
				...
				'description'     => esc_html__( 'This setting will turn on and off the meta section.', 'power-builder' ),
			),
			'background_color' => array(
			...
			'background_image' => array(
				...
				'choose_text'        => esc_attr__( 'Choose a Background', 'power-builder' ),
				'update_text'        => esc_attr__( 'Set As Background', 'power-builder' ),
				'description'        => esc_html__( 'Upload your desired image, or type in the URL to the image you would like to use as the background for the slider.', 'power-builder' ),
			),
			'show_image' => array(
				...
				'description'       => esc_html__( 'This setting will turn on and off the featured image in the slider.', 'power-builder' ),
			),
			'image_placement' => array(
				'label'             => esc_html__( 'Image Placement', 'power-builder' ),
				'type'              => 'select',
				'option_category'   => 'configuration',
				'options'           => array(
					'background' => esc_html__( 'Background', 'power-builder' ),
				...
				'description'       => esc_html__( 'Select how you would like to display the featured image in slides', 'power-builder' ),
			),
			'parallax' => array(
				...
				'description'        => esc_html__( 'Enabling this option will give your background images a fixed position as you scroll.', 'power-builder' ),
			),
			...
			'use_bg_overlay'      => array(
				'label'           => esc_html__( 'Use Background Overlay', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'yes', 'power-builder' ),
				...
				'description'     => esc_html__( 'When enabled, a custom overlay color will be added above your background image and behind your slider content.', 'power-builder' ),
			),
			'bg_overlay_color' => array(
				...
				'custom_color'      => true,
				'depends_show_if'   => 'on',
				'description'       => esc_html__( 'Use the color picker to choose a color for the background overlay.', 'power-builder' ),
			),
			'use_text_overlay'      => array(
				'label'           => esc_html__( 'Use Text Overlay', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
				...
				'description'     => esc_html__( 'When enabled, a background color is added behind the slider text to make it more readable atop background images.', 'power-builder' ),
			),
			'text_overlay_color' => array(
				'label'             => esc_html__( 'Text Overlay Color', 'power-builder' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'depends_show_if'   => 'on',
				'description'       => esc_html__( 'Use the color picker to choose a color for the text overlay.', 'power-builder' ),
			),
			'remove_inner_shadow' => array(
				'label'           => esc_html__( 'Remove Inner Shadow', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
			...
			'background_position' => array(
				'label'           => esc_html__( 'Background Image Position', 'power-builder' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options' => array(
					'default'       => esc_html__( 'Default', 'power-builder' ),
					'top_left'      => esc_html__( 'Top Left', 'power-builder' ),
					'top_center'    => esc_html__( 'Top Center', 'power-builder' ),
					'top_right'     => esc_html__( 'Top Right', 'power-builder' ),
					'center_right'  => esc_html__( 'Center Right', 'power-builder' ),
					'center_left'   => esc_html__( 'Center Left', 'power-builder' ),
					'bottom_left'   => esc_html__( 'Bottom Left', 'power-builder' ),
					'bottom_center' => esc_html__( 'Bottom Center', 'power-builder' ),
					'bottom_right'  => esc_html__( 'Bottom Right', 'power-builder' ),
				),
				'depends_show_if'   => 'off',
			),
			'background_size' => array(
				'label'           => esc_html__( 'Background Image Size', 'power-builder' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
					'default' => esc_html__( 'Default', 'power-builder' ),
					'contain' => esc_html__( 'Fit', 'power-builder' ),
					'initial' => esc_html__( 'Actual Size', 'power-builder' ),
				),
				'depends_show_if'   => 'off',
			),
			'auto' => array(
				'label'           => esc_html__( 'Automatic Animation', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
				...
				'description'        => esc_html__( 'If you would like the slider to slide automatically, without the visitor having to click the next button, enable this option and then adjust the rotation speed below if desired.', 'power-builder' ),
			),
			'auto_speed' => array(
				'label'             => esc_html__( 'Automatic Animation Speed (in ms)', 'power-builder' ),
				'type'              => 'text',
				'option_category'   => 'configuration',
				'depends_default'   => true,
				'description'       => esc_html__( "Here you can designate how fast the slider fades between each slide, if 'Automatic Animation' option is enabled above. The higher the number the longer the pause between each rotation.", 'power-builder' ),
			),
			'auto_ignore_hover' => array(
				'label'           => esc_html__( 'Continue Automatic Slide on Hover', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'depends_default' => true,
				'options'         => array(
				...
				'description' => esc_html__( 'Turning this on will allow automatic sliding to continue on mouse hover.', 'power-builder' ),
			),
			'top_padding' => array(
				'label'           => esc_html__( 'Top Padding', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'mobile_options'  => true,
			...
			'bottom_padding' => array(
				'label'           => esc_html__( 'Bottom Padding', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'mobile_options'  => true,
			...
			'hide_content_on_mobile' => array(
				'label'           => esc_html__( 'Hide Content On Mobile', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
			...
			'hide_cta_on_mobile' => array(
				'label'           => esc_html__( 'Hide CTA On Mobile', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
			...
			'show_image_video_mobile' => array(
				'label'           => esc_html__( 'Show Image On Mobile', 'power-builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
					'off' => esc_html__( 'No', 'power-builder' ),
			...
			'text_border_radius' => array(
				'label'           => esc_html__( 'Text Overlay Border Radius', 'power-builder' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'default'         => '3',
			...
			'arrows_custom_color' => array(
				'label'        => esc_html__( 'Arrows Custom Color', 'power-builder' ),
				'type'         => 'color',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
			),
			'dot_nav_custom_color' => array(
				'label'        => esc_html__( 'Dot Nav Custom Color', 'power-builder' ),
				'type'         => 'color',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
			),
						...
						<div class="tm_pb_slide_content <?php if ( 'on' === $hide_content_on_mobile ) { echo esc_attr( $hide_on_mobile_class ); } ?>">
							...
							if ( 'off' !== $show_meta ) {
								printf(
									...
									tm_get_safe_localization( sprintf( __( 'by %s', 'power-builder' ), '<span class="author vcard">' .  tm_pb_get_the_author_posts_link() . '</span>' ) ),
									tm_get_safe_localization( sprintf( __( '%s', 'power-builder' ), '<span class="published">' . esc_html( get_the_date() ) . '</span>' ) ),
									get_the_category_list(', '),
									sprintf( esc_html( _nx( '1 Comment', '%s Comments', get_comments_number(), 'number of comments', 'power-builder' ) ), number_format_i18n( get_comments_number() ) )
								);
							}
							?>
							<?php
