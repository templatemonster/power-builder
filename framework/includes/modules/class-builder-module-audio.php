...
class Tm_Builder_Module_Audio extends Tm_Builder_Module {
	function init() {
		$this->name = esc_html__( 'Audio', 'power-builder' );
		$this->icon = 'f028';
		...
		$this->advanced_options = array(
			'fonts' => array(
				...
				'caption'   => array(
					'label'    => esc_html__( 'Caption', 'power-builder' ),
					'css'      => array(
		...
		$this->custom_css_options = array(
			'audio_cover_art' => array(
				'label'    => esc_html__( 'Audio Cover Art', 'power-builder' ),
				'selector' => '.tm_pb_audio_cover_art',
			),
			'audio_content' => array(
				'label'    => esc_html__( 'Audio Content', 'power-builder' ),
				'selector' => '.tm_pb_audio_module_content',
			),
			'audio_title' => array(
				'label'    => esc_html__( 'Audio Title', 'power-builder' ),
				'selector' => '.tm_pb_audio_module_content h2',
			),
			'audio_meta' => array(
				'label'    => esc_html__( 'Audio Meta', 'power-builder' ),
				'selector' => '.tm_audio_module_meta',
			),
			'audio_buttons' => array(
				'label'    => esc_html__( 'Player Buttons', 'power-builder' ),
			...
			'audio_timer' => array(
				'label'    => esc_html__( 'Player Timer', 'power-builder' ),
				'selector' => '.mejs-time.mejs-currenttime-container.custom',
			),
			'audio_sliders' => array(
				'label'    => esc_html__( 'Player Sliders', 'power-builder' ),
			...
			'audio_sliders_current' => array(
				'label'    => esc_html__( 'Player Sliders Current', 'power-builder' ),
	...
	function get_fields() {
		$fields = array(
			'audio' => array(
				'label'              => esc_html__( 'Audio', 'power-builder' ),
				'type'               => 'upload',
				'option_category'    => 'basic_option',
				'data_type'          => 'audio',
				'upload_button_text' => esc_attr__( 'Upload an audio file', 'power-builder' ),
				'choose_text'        => esc_attr__( 'Choose an Audio file', 'power-builder' ),
				'update_text'        => esc_attr__( 'Set As Audio for the module', 'power-builder' ),
				'description'        => esc_html__( 'Define the audio file for use in the module. To remove an audio file from the module, simply delete the URL from the settings field.', 'power-builder' ),
			),
			'title' => array(
				'label'           => esc_html__( 'Title', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define a title.', 'power-builder' ),
			),
			'artist_name' => array(
				'label'           => esc_html__( 'Artist Name', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define an artist name.', 'power-builder' ),
			),
			'album_name' => array(
				'label'           => esc_html__( 'Album name', 'power-builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( 'Define an album name.', 'power-builder' ),
			),
			'image_url' => array(
				'label'              => esc_html__( 'Cover Art Image URL', 'power-builder' ),
				'type'               => 'upload',
				'option_category'    => 'basic_option',
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		if ( '' !== $artist_name || '' !== $album_name ) {
			...
			if ( '' !== $artist_name ) {
				$artist_name = sprintf(
					tm_get_safe_localization( _x( 'by <strong>%1$s</strong>', 'Audio Module meta information', 'power-builder' ) ),
