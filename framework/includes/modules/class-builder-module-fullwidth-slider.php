...
class Tm_Builder_Module_Fullwidth_Slider extends Tm_Builder_Module {
	function init() {
		$this->name            = esc_html__( 'Fullwidth Slider', 'power-builder' );
	...
	function get_fields() {
		$fields = array(
			'show_arrows' => array(
				...
				'description'        => esc_html__( 'This setting allows you to turn the navigation arrows on or off.', 'power-builder' ),
			),
			'show_pagination' => array(
				'label'           => esc_html__( 'Controls', 'power-builder' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'Show Slider Controls', 'power-builder' ),
					'off' => esc_html__( 'Hide Slider Controls', 'power-builder' ),
				),
				'description'        => esc_html__( 'Disabling this option will remove the circle button at the bottom of the slider.', 'power-builder' ),
			),
			'auto' => array(
