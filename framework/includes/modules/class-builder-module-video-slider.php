...
class Tm_Builder_Module_Video_Slider extends Tm_Builder_Module {
	function init() {
		$this->name            = esc_html__( 'Video Slider', 'power-builder' );
		$this->slug            = 'tm_pb_video_slider';
		$this->child_slug      = 'tm_pb_video_slider_item';
		$this->child_item_text = esc_html__( 'Video', 'power-builder' );
		$this->icon = 'f008';
		...
		$this->custom_css_options = array(
			'play_button' => array(
				'label'    => esc_html__( 'Play Button', 'power-builder' ),
				'selector' => '.tm_pb_video_play',
			),
			'thumbnail_item' => array(
				'label'    => esc_html__( 'Thumbnail Item', 'power-builder' ),
				'selector' => '.tm_pb_carousel_item',
			),
			'arrows' => array(
				'label'    => esc_html__( 'Slider Arrows', 'power-builder' ),
	...
	function get_fields() {
		$fields = array(
			'show_image_overlay' => array(
				'label'           => esc_html__( 'Display Image Overlays on Main Video', 'power-builder' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'hide' => esc_html__( 'Hide', 'power-builder' ),
					'show' => esc_html__( 'Show', 'power-builder' ),
				),
				'description'        => esc_html__( 'This option will cover the player UI on the main video. This image can either be uploaded in each video setting or auto-generated by Divi.', 'power-builder' ),
			),
			'show_arrows' => array(
			...
			'show_thumbnails' => array(
				'label'             => esc_html__( 'Slider Controls', 'power-builder' ),
				'type'              => 'select',
				'option_category'   => 'configuration',
				'options'           => array(
					'on'  => esc_html__( 'Use Thumbnail Track', 'power-builder' ),
					'off' => esc_html__( 'Use Dot Navigation', 'power-builder' ),
				),
				'description'        => esc_html__( 'This setting will let you choose to use the thumbnail track controls below the slider or dot navigation at the bottom of the slider.', 'power-builder' ),
			),
			...
			'thumbnail_overlay_color' => array(
				'label'             => esc_html__( 'Thumbnail Overlay Color', 'power-builder' ),
				'type'              => 'color-alpha',
				'custom_color'      => true,
				'tab_slug'          => 'advanced',
			),
